...
public abstract class NonStaticEntity extends AnimatedEntity {

    public NonStaticEntity(String id, Point position, List<PImage> images, String type, int actionPeriod, int animationPeriod){
